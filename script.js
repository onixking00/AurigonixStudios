document.addEventListener('DOMContentLoaded', () => {
    ...
    if (prefersReducedMotion) {
        return; // Skip ambient particle animation for reduced-motion users
    }
    ...
    function createFirefly() {
        ...
        firefly.style.boxShadow = `0 0 8px hsl(${hue}, 100%, 70%), 0 0 16px hsl(${hue}, 100%, 50%)`;
